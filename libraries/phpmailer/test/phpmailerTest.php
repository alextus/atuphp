...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        if (file_exists('../../../PHPMailer-master/PHPMailer-master/test/testbootstrap.php')) {
            include '../../../PHPMailer-master/PHPMailer-master/test/testbootstrap.php'; //Overrides go in here
        }
