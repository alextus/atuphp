 ...
 * @link		http://ATUphp.com/user_guide/libraries/security.html
 */
class ATU_Security {
	 ...
	 * @access protected
	 */
	protected $_csrf_token_name		= 'ATU_csrf_token';
	/**
	 ...
	 * @access protected
	 */
	protected $_csrf_cookie_name	= 'ATU_csrf_token';
	/**
	...
	protected function _remove_evil_attributes($str, $is_image)
	{
		...
		$evil_attributes = array('on\w*',  'xmlns', 'formaction', 'form', 'xlink:href', 'FSCommand', 'seekSegmentTime');//'style',
